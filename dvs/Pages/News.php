          ...
          <div class="hidden md:flex flex-col md:flex-row md:ml-auto mt-3 md:mt-0" id="navbar-collapse">
            ...
            <div class="relative group z-50">
              ...
              <div class="absolute left-0 hidden group-hover:block bg-orange-100 shadow-lg rounded mt-2 w-48 z-50">
                <a href="#" class="block p-2 lg:px-4 md:mx-2 text-white rounded bg-orange-600 rounded-lg hover:bg-orange-500 transition-colors duration-300">News</a>
...
<section class="m-5 md:m-0 md:mr-28 md:ml-28 py-8" data-aos="fade-up">
  <h2 class="text-5xl md:text-7xl font-bold text-center text-orange-600 mb-4">Trending News</h2>
  ...
  <div class="container mx-auto overflow-x-auto">
    <div class="flex space-x-4 md:space-x-6">
      ...
      <div class="bg-gray-50 rounded-lg shadow-lg p-6 min-w-[250px] md:min-w-[300px]">
        <img src="https://via.placeholder.com/400x250" alt="Blog Image 1" class="rounded-t-lg mb-4">
        <h3 class="text-2xl font-bold text-gray-900 mb-2">Blog Post Title 1</h3>
        <p class="text-gray-600 mb-4">
          A short description of the blog post that captures the reader's interest and gives a brief overview of the content.
        </p>
        <a href="#" class="text-orange-600 font-bold hover:underline">Read More</a>
      </div>
      <!-- Blog Card 2 -->
      <div class="bg-gray-50 rounded-lg shadow-lg p-6 min-w-[250px] md:min-w-[300px]">
        <img src="https://via.placeholder.com/400x250" alt="Blog Image 2" class="rounded-t-lg mb-4">
        <h3 class="text-2xl font-bold text-gray-900 mb-2">Blog Post Title 2</h3>
        <p class="text-gray-600 mb-4">
          A short description of the blog post that captures the reader's interest and gives a brief overview of the content.
        </p>
        <a href="#" class="text-orange-600 font-bold hover:underline">Read More</a>
      ...
      <!-- Blog Card 3 -->
      <div class="bg-gray-50 rounded-lg shadow-lg p-6 min-w-[250px] md:min-w-[300px]">
        <img src="https://via.placeholder.com/400x250" alt="Blog Image 3" class="rounded-t-lg mb-4">
        <h3 class="text-2xl font-bold text-gray-900 mb-2">Blog Post Title 3</h3>
        <p class="text-gray-600 mb-4">
          A short description of the blog post that captures the reader's interest and gives a brief overview of the content.
        </p>
        <a href="#" class="text-orange-600 font-bold hover:underline">Read More</a>
      ...
      <!-- Blog Card 4 -->
      <div class="bg-gray-50 rounded-lg shadow-lg p-6 min-w-[250px] md:min-w-[300px]">
        <img src="https://via.placeholder.com/400x250" alt="Blog Image 4" class="rounded-t-lg mb-4">
        <h3 class="text-2xl font-bold text-gray-900 mb-2">Blog Post Title 4</h3>
        <p class="text-gray-600 mb-4">
          A short description of the blog post that captures the reader's interest and gives a brief overview of the content.
        </p>
        <a href="#" class="text-orange-600 font-bold hover:underline">Read More</a>
