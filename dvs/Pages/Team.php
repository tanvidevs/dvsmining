...
<head>
  ...
  <title>Our Team | Dvsmining Pvt. Ltd.</title>
</head>
...
<section class="text-gray-600 body-font md:mr-24 ml-0 md:ml-24">
    <div class="container px-5 py-24 mx-auto">
      <div class="flex flex-col text-center w-full mb-5">
        <h2 class="text-5xl md:text-7xl font-bold mb-1 text-center text-orange-600 mb-4">Our Team</h2>
