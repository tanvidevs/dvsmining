    ...
    <div class="container px-5 mx-auto">
      <div class="flex flex-wrap -m-4">
        ...
        <div class="p-4 w-full md:w-1/3" data-aos="fade-up">
          <div class="flex rounded-lg h-full bg-gray-100 hover:bg-orange-100 p-8 flex-col">
            ...
            <div class="flex-grow">
              <p class="leading-relaxed text-base">+1 234 567 890</p>
            </div>
          </div>
        </div>
        <!-- Email -->
        <div class="p-4 w-full md:w-1/3" data-aos="fade-up">
          <div class="flex rounded-lg h-full bg-gray-100 hover:bg-orange-100 p-8 flex-col">
            ...
            <div class="flex-grow">
              <p class="leading-relaxed text-base">contact@example.com</p>
            </div>
          </div>
        </div>
        <!-- Address -->
        <div class="p-4 w-full md:w-1/3" data-aos="fade-up">
          <div class="flex rounded-lg h-full bg-gray-100 hover:bg-orange-100 p-8 flex-col">
            ...
            <div class="flex-grow">
              <p class="leading-relaxed text-base">123 Main St, Anytown, USA</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="flex flex-col md:flex-row gap-10">
            ...
            <div class="lg:w-2/3 md:w-2/3">
                <form class="bg-white p-8 rounded-lg shadow-md">
                    <h2 class="text-gray-900 text-lg mb-5 font-medium">Enquiry / Suggestion Form</h2>
                    <!-- Name Field -->
                    <div class="mb-4">
            ...
            <!-- Map Section -->
            <div class="lg:w-2/3 md:w-2/3">
                <h2 class="text-gray-900 text-2xl mb-5 font-bold">Locate Us on Google Map</h2>
                ...
                <div class="flex md:flex-row flex-col">
                    <div class="mt-10 bg-white p-8 rounded-lg shadow-md mr-0 md:mr-5">
                        <h1 class="text-gray-900 text-2xl mb-2 font-bold">Office Details</h1>
