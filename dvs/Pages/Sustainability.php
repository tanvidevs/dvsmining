...
<section class="py-10">
    <div class="container mx-auto px-5 md:px-20">
      <div class="text-center mb-10">
        <h2 class="text-5xl md:text-7xl font-bold text-center text-orange-600 mb-4">Sustainability</h2>
  <p class="mb-6 text-center text-xl">Our commitment to sustainable mining practices and environmental protection.</p>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10" data-aos="fade-up">
        ...
        <div class="bg-white rounded-lg shadow-lg p-6 hover:shadow-2xl transition-shadow duration-300">
          <img src="../Assets/Images/sustainability1.jpg" alt="Sustainability Initiative 1" class="rounded-t-lg w-full h-48 object-cover">
        ...
        <div class="bg-white rounded-lg shadow-lg p-6 hover:shadow-2xl transition-shadow duration-300">
          <img src="../Assets/Images/sustainability2.jpg" alt="Sustainability Initiative 2" class="rounded-t-lg w-full h-48 object-cover">
        ...
        <div class="bg-white rounded-lg shadow-lg p-6 hover:shadow-2xl transition-shadow duration-300">
          <img src="../Assets/Images/sustainability3.jpg" alt="Sustainability Initiative 3" class="rounded-t-lg w-full h-48 object-cover">
      ...
      <p class="mt-10 text-justify">Sustainable mining is a practice that seeks to minimize the environmental, social, and economic impacts of mining operations while ensuring the long-term viability of mineral resources. It's a delicate balancing act that requires careful consideration of various factors.!</p>

      <ul class="list-disc list-inside text-gray-900 mt-4">
        <li><strong>Technological Advancements:</strong> New technologies can improve efficiency, reduce environmental impact, and enable more sustainable mining practices.</li>
        <li><strong>Global Demand:</strong> The increasing demand for minerals presents both opportunities and challenges.</li>
        <li><strong>Regulatory Frameworks:</strong> Strong and effective regulations are essential for ensuring sustainable mining.</li>
        <li><strong>Stakeholder Collaboration:</strong> Cooperation among governments, mining companies, communities, and environmental organizations is crucial.</li>
      </ul>
    </div>
  </section>
